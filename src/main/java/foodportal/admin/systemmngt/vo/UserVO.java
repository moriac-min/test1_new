...
public class UserVO extends WqBaseBean{
	...
	private BigDecimal	dept_inner_lv;
	private BigDecimal	pstofc_inner_lv;
	...
	private Date		pswd_last_chng_dtm;
	...
	public BigDecimal getDept_inner_lv() {
		return dept_inner_lv;
	}

	public void setDept_inner_lv(BigDecimal dept_inner_lv) {
		this.dept_inner_lv = dept_inner_lv;
	}

	public BigDecimal getPstofc_inner_lv() {
		return pstofc_inner_lv;
	}

	public void setPstofc_inner_lv(BigDecimal pstofc_inner_lv) {
	...
	public Date getPswd_last_chng_dtm() {
		return pswd_last_chng_dtm;
	}

	public void setPswd_last_chng_dtm(Date pswd_last_chng_dtm) {
