 ...
 *  수정일      수정자   수정내용
 *  ---------- -------- ---------------------------
 *  2014.09.17 박재형 최초 생성 ( 다운로드 공통샘플 에러나서 자바로 만들다 ㅠㅠ)
 * </pre>
 *
...
public class DownloadUtil {
   ...
   * @throws IOException
   */
  public static void download(HttpServletRequest request, HttpServletResponse response, File file, String downloadFileName)
