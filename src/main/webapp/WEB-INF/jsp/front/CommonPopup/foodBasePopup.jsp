...
<input type="hidden" id="cmmn_cd" name="cmmn_cd" value="CP02">         <!-- 1399 공통코드 -->
    ...
    <div class="inner-body">
        <div id="origin">
            <div class="emphasis">
                <p style="margin:0;">검색할 원산지의 이름을 입력하십시오.<br>
                    예)한국, 미국, 일본 등</p>
            </div>
            <fieldset>
                <legend>원산지검색</legend>
                <dl class="item">
                    <dt><label for="search_keyword">원산지명</label></dt>
...
<script type="text/javascript">
    ...
    ****************************************/
     ...
     ****************************************/
     function searchList(){
           ...
           $.ajax({ 
               ...
               dataType:'json', 
               type:'POST',
               url:"${contextPath}/popup/CommonPopup/searchFoodBase.do", 
    ...
    //목록 그리기
     function fn_drawList(list){
        ...
        for(var i=0; i<listLangth; i++){
            ...
            content += "</ul>";
             */
        	content += "<li><a href='#' onclick=\"javascript:setSelectedVal('"+list[i].fnprt_cd+"','"+list[i].fnprt_cd_nm+"'); return false;\">"+list[i].no+" "+list[i].fnprt_cd_nm+"</a></li>";
        }
    ...
    function setSelectedVal(value, name){
    	parent.fn_callbackFoodBase(value, name);
    }
</script>
