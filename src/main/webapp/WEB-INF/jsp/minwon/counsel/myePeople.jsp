                ...
                <div class="page-container">
                    ...
                    <article>
                        ...
                        <script type="text/javascript">
                            document.getElementById('epeople').innerHTML = '<iframe title="나의 일반민원" src="http://www.epeople.go.kr/jsp/user/frame/pc/mycvreq/UPcMyCvreqList.jsp?anc_code=1471000&amp;channel=1471000&amp;menu_code=PC002" id="mergerFrame" name="mergerFrame" scrolling="no" width="700"  height="300" frameborder="0" marginwidth="0" marginheight="0" onload="javascript:AfterSubmitProcess()"></iframe>';
						</script> 
                        <!-- 국민신문고 -->
