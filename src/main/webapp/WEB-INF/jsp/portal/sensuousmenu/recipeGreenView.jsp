...
<!-- 				 <a href="recipe-video.html" class="btn-mov fancybox.iframe">레시피동영상</a> -->
		...
		<div class="section">
			...
			<div class="sr season">
				...
				<a class="ingredient fancybox.iframe btn btn-sm btn-danger" data-fancybox-group="iframe" href="/popup/recipeNtrtDetail.do?food_ntrt_no=${nut.food_ntrt_no }">${nut.food_ntrt_nm }</a>
				</c:forEach>
			</div>
