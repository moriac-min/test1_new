<%@ page contentType="charset=euc-kr" language="java" errorPage="" import="java.io.*,org.w3c.dom.*,websquare.WebSquareConfig,java.net.*,websquare.upload.handl.*,websquare.util.*" 
%><%
...
try {
    ...
    if( fileName.indexOf("." + File.separator) > -1 || fileName.indexOf(".." + File.separator) > -1 ) {
	...
	System.out.println("==============222======uplodBaseDir=======>"+uplodBaseDir);
	System.out.println("==============222======uplodsubDirold=======>"+uplodsubDirold);
	System.out.println("==============222======uplodsubDir=======>"+uplodsubDir);
