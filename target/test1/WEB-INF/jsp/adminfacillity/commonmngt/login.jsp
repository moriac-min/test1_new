...
<script type="text/javaScript" language="javascript" defer="defer">
	function fn_login(){
		document.loginForm.action = "<c:url value='/adminfacillity/commonmngt/selectLogin.do'/>";
...
<div id="content_pop">
	...
	<div id="title">
		<ul>
			<li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>"> Login </li>
		</ul>
	</div>
	<!-- // 타이틀 -->
	<!-- List -->
