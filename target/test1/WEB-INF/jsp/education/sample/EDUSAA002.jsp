...
<c:set var="registerFlag" value="${empty edusaVO.id ? '등록' : '수정'}"/>
<title>List <c:out value="${registerFlag}"/> </title>
<link type="text/css" rel="stylesheet" href="<c:url value='/css/egovframework/sample.css'/>"/>

<validator:javascript formName="educationSampleVO" staticJavascript="false" xhtml="true" cdata="false"/>
