...
$(function() {
	...
	if(status == null || status == ''){
		...
		data = {message: '${m:getMessage("msg.complain.business.login")}', url: url, aTagStyle: '', buttonNm: '확인'};
		...
		url = '${contextPath}/minwon/complain/businessNotifyLogin.do';
...
var fn_chkCustomerNotifyDoc = function(){
	...
	var form = $('<form/>', {method: 'post', action: '${contextPath}/minwon/complain/businessNotifyView.do'});
