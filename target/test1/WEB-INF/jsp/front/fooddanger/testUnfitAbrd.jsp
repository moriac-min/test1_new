	 ...
	 ****************************************/
	 ...
	 function fn_drawList(list){
        ...
        for(var i=0; i<listLangth; i++){
            ...
            content += list[i].prdt_nm+"</li>";
            content += "<li class='product-name-eng'>"+list[i].prdt_nm+"</li>";//영문명?
            content += "<li class='product-info'>";
            content += "<dl>";
            content += "<dt>제품구분</dt>";
            content += "<dd>"+list[i].prdt_type_nm+"</dd>";
            content += "<dt>품목명</dt>";
            content += "<dd>"+list[i].prdlst_cd_nm+"</dd>";
            content += "<dt>제조국가</dt>";
            content += "<dd>"+list[i].orgnp_prdlc_nm+"</dd>";	
            content += "<dt>제조/수출회사</dt>";
            content += "<dd>"+list[i].bssh_nm+"</dd>";    	
            content += "</dl>";
            content += "</li>";
            ...
            content += "<dd class='issue'>"+list[i].impropt_test_itm;
            if(list[i].impropt_test_itm_stnd != ''){	//규격
	            content += list[i].impropt_test_itm_stnd;
            }
            if(list[i].impropt_test_itm_rslt != ''){	//결과
            	content += list[i].impropt_test_itm_rslt;
            }
            content += "</dd>";
            content += "<dt>처리기관</dt>";
            content += "<dd>"+list[i].report_instt_cd_nm+"</dd>";//보고기관
            content += "<dt>부적합일자</dt>";
            content += "<dd>"+list[i].report_dtm+"</dd>";//보고일시
            content += "</dl>";
            content += "</li>";
            content += "</ul>";
        }
