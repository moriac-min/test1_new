...
<c:set var="ctgry_type_cd">${boardSetting.ctgry_type_cd}</c:set>
	...
	<section>
      <div id="header">
          <div class="board-head">
              ...
              <c:if test="${boardSetting.bbs_type_cd == '910'}">
              <a href="newsletter.html" class="btn btn-primary btn-right newsletter fancybox.iframe" role="button">뉴스레터 구독신청/해지</a>  
              </c:if>
               ...
               <legend>검색</legend>
            	...
            	<c:if test="${boardSetting.ctgry_type_cd == 'CTG_TYPE01' || boardSetting.ctgry_type_cd == 'CTG_TYPE02'}">
                  ...
                  <jsp:include page="${boardSetting.bbs_templet_nm}"/>
                   <%--<jsp:include page="bbsType05_list.jsp"/>--%>
	...
	****************************************/
	...
	$(function(){
		...
		$('.pagination').pagination({
            items: parseInt('${boardSetting.total_cnt}'),
            itemsOnPage: parseInt($('#show_cnt').val()),
