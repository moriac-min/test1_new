...
function fn_idStep2(){
	...
	//인증후 디비에 사용자 검색(이름,휴대폰) - 아이디 리턴
	//{findIdOk} - 아이디 넣어 보여주기
...
function fn_pwdStep(step){
	if(step == 'step2'){
		//아이디, 휴대폰(이메일) 인증 번호 받은후 비밀번호 재 설정 리턴
		
		$("#tab2").empty();
		$("#tab2").html($("#findPwdStep2S").html());
	}else{
		//비밀 번호 재 설정후 화면
		//비밀번호 형식 체크 필요 - 8~16 영대소,숫자,특수문자
		var passwd1 = $("passwd").val();
		var passwd2 = $("re-password").val();
		if(passwd1 == passwd2){
			// 비밀 번호 업데이트 필요
			fn_rePasswordSet();//id, newPwd 넘기기
		}
		//passwd   re-password
		$("#tab2").empty();
...
function fn_phoneChk(){
	var alertMessage = "숫자로만 입력해 주세요.";
	fn_num('phone',alertMessage);
}

function fn_emailChk(){
	var alertMessage = "이메일 형식에 맞게 입력해 주세요.";
	fn_email('email',alertMessage);
}

function fn_rePasswordSet(id,newPwd){
	var param = "id="+id+"&newPwd="+newPwd;
	$.ajax({
		type: "post",
		url : "/front/member/ajax/rePasswordSet.do?"+param,
		dataType : "json",
...
<script type="text" id="findIdStep1">
			<h1>아이디 찾기</h1>
		                ...
		                <table>
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                            ...
		                            <td><input type="text" id="phone" name="phone" onfocus="if(this.value !='')this.value='';" onblur="if(this.value.length==0){this.value='숫자만 입력하세요.';}" onChange="javascript:fn_phoneChk(this.value);" value="숫자만 입력하세요."></td>
		                        </tr>
		                        <tr>
		                            <th><label for="phone-code">인증번호</label></th>
		                            <td><a href="#" class="btn btn-info" onclick="javascript:fn_getNumber('id','m');">인증번호 받기</a>
		                ...
		                <table>
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                            ...
		                            <td><input type="text" id="email" name="email" onChange="fn_emailChk(this.value)" value=""></td>
		                        </tr>
		                        <tr>
		                            <th><label for="email-code">인증번호</label></th>
		                            <td><a href="#" class="btn btn-info" onclick="javascript:fn_getNumber('id','e');">인증번호 받기</a>
		        ...
		        <div class="footer"> <a href="#" class="btn btn-default btn-lg" onclick="javascript:fn_idStep2();">다음</a> </div>
</script>
...
<script type="text" id="findPwdStep1">
			<h1>비밀번호 찾기<</h1>
		            ...
		            <fieldset>
		                ...
		                <table>
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                            <th><label for="phone-code">인증번호</label></th>
		                            <td><a href="#" class="btn btn-info" onclick="javascript:fn_getNumber('pwd','m');">인증번호 받기</a>
		                                <input type="text" id="phone-code" name="phone-code" onfocus="if(this.value !='')this.value='';" onblur="if(this.value.length==0){this.value='인증번호 6자리 숫자 입력';}" value="인증번호 6자리 숫자 입력"></td>
		                        </tr>
		                    </tbody>
		                </table>
		            ...
		            <fieldset>
		                ...
		                <table>
		                    ...
		                    <tbody>
		                        ...
		                        <tr>
		                            <th><label for="email-code">인증번호</label></th>
		                            <td><a href="#" class="btn btn-info" onclick="javascript:fn_getNumber('pwd','e');">인증번호 받기</a>
		                                <input type="text" id="email-code" name="email-code"onfocus="if(this.value !='')this.value='';" onblur="if(this.value.length==0){this.value='인증번호 6자리 숫자 입력';}" value="인증번호 6자리 숫자 입력"></td>
		                        </tr>
		                    </tbody>
		                </table>
		        ...
		        <div class="footer"> <a href="#" class="btn btn-default btn-lg" onclick="javascript:fn_pwdStep('step2');">다음</a> </div>
</script>
...
<script type="text" id="findIdStep2S">
    ...
    <div class="result">
    	<span class="user-id"><span>{findIdOk}</span></span>
	</div>
    <div class="footer">
...
<div class="pw-dscr">
        ...
        <div class="footer"> <a href="#" class="btn btn-default btn-lg" onclick="javascript:fn_pwdStep('step3');">다음</a> </div>
</script>
