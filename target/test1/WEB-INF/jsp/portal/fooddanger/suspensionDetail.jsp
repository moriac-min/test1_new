...
<div class="inner-body">
    ...
    <div class="issue-info">
    	<dl>
            ...
            <dd>${suspension.suspensionDetail.bsshnm}</dd>
        	<dt>영업자주소</dt>
            <dd>${suspension.suspensionDetail.addr}/${suspension.suspensionDetail.addr_dtl}</dd>
        	<dt>전화번호</dt>
            <dd>${suspension.suspensionDetail.regstr_telno}</dd>
        	<dt>바코드번호</dt>
